  ...
  render() {
    ...
    return (
      <PanelDetails data-test="details">
        ...
        />
        <div className='st2web_switch_area'>
        <DetailsSwitch
          ...
          <DetailsBody>
            ...
            { action.runner_type === 'mistral-v2' || action.runner_type === 'orquesta' ? (
                <Link
                  ...
                  className="st2-forms__button st2-details__toolbar-button edit_btn"
                  onClick={e => this.setWindowName(e)}
                >
                  Edit
                </Link>
              ) : null}
              <Button className="st2-forms__button st2-details__toolbar-button trash_btn" value="Delete" onClick={(e) => this.openDeleteModel(e)}/>
              <Button disabled={this.props.id !== action.ref} className="st2-forms__button st2-details__toolbar-button clone_btn" value="Clone" onClick={(e) => this.openModel(e)} />
              <Button flat value="Preview" onClick={() => this.handleToggleRunPreview()} className="preview" />
              <Button 
                disabled={ 
                ...
                className="run_btn" value="Run" data-test="run_submit" onClick={(e) => this.handleRun(e, action.ref, this.state.runValue, this.state.runTrace || undefined)} 
              />
                  ...
                  <FlexTable>
                    { executions.map((execution) => ([
                      ...
                      >
                        ...
                        <FlexTableColumn className="st2-actions__details-column-history">
                          <i className={this.state.executionsVisible[execution.id] ? 'icon-chevron-up' : 'icon-chevron-down'} />
                        </FlexTableColumn>
                      </FlexTableRow>,
